"""
Test script for AdaBoost Classifier implementation.
Tests the classifier on the Iris dataset using Decision Tree as base estimator.
...
def create_base_estimator() -> DecisionTreeClassifier:
    """
    Create and configure the base estimator for AdaBoost.

    Returns:
        DecisionTreeClassifier: Configured decision tree
    """
...
def main():
    """
    Main function to run the AdaBoost classifier on Iris data.
    """
    try:
        # Set up paths
